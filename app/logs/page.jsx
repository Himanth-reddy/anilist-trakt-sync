      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center gap-3 text-sm text-gray-500">
          ...
          <button
            ...
            className={`inline-flex items-center px-3 py-1 rounded-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500 transition-colors ${isManualRefresh

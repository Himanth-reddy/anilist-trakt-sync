                ...
                <div className="mb-2">
                    ...
                    <div className="flex gap-3">
                        <input
                            ...
                            onKeyDown={(e) => { if (e.key === 'Enter' && manualId.trim()) syncShow(); }}
                        ...
                        <button
                            ...
                            title={!manualId.trim() && !manualLoading ? "Enter an AniList ID to sync" : undefined}
            ...
            <div className="bg-[#111] border border-[#333] p-6 rounded-lg-none mb-6">
                ...
                <div className="flex gap-3 mb-2">
                    <input
                        ...
                        onKeyDown={(e) => { if (e.key === 'Enter' && authCode.trim()) exchangeTraktCode(); }}
                    ...
                    <button
                        ...
                        aria-busy={authLoading}
                        title={!authCode.trim() && !authLoading ? "Paste an auth code to save" : undefined}

                ...
                <div className="mb-2">
                    ...
                    <div className="flex gap-3">
                        <input
                            ...
                            className="flex-1 px-4 py-2 bg-transparent rounded-lg border border-gray-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500 transition-colors"
                        ...
                        <button
                            ...
                            className={`inline-flex items-center gap-2 px-6 py-2 rounded-lg font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500 transition-colors ${manualLoading || !manualId.trim()
            ...
            <div className="bg-[#111] border border-[#333] p-6 rounded-lg-none mb-6">
                ...
                <div className="flex gap-3 mb-2">
                    <input
                        ...
                        className="flex-1 px-4 py-2 bg-transparent rounded-lg border border-gray-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-500 transition-colors"
                    ...
                    <button
                        ...
                        aria-busy={authLoading}
                        title={!authCode.trim() ? "Please enter a Trakt auth code" : ""}
                        className={`inline-flex items-center gap-2 px-4 py-2 rounded-lg font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-500 transition-colors ${authLoading || !authCode.trim()
                            ? 'bg-transparent border border-[#333] cursor-not-allowed text-gray-600 uppercase tracking-wider'
                            : 'bg-transparent border border-green-600 text-green-500 hover:bg-green-600 hover:text-white uppercase tracking-wider'
                            }`}
                    >

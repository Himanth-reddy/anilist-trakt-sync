                ...
                <div className="mb-2">
                    ...
                    <div className="flex gap-3">
                        ...
                        <button
                            ...
                            title={!manualId.trim() ? "Please enter an AniList ID" : undefined}
                            className={`inline-flex items-center gap-2 px-6 py-2 rounded-lg font-medium transition-colors ${manualLoading || !manualId.trim()
                                ...
                                : 'bg-transparent border border-red-600 text-red-500 hover:bg-red-600 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500 uppercase tracking-wider'
                                }`}
                        >
            ...
            <div className="bg-[#111] border border-[#333] p-6 rounded-lg-none mb-6">
                ...
                <div className="flex gap-3 mb-2">
                    ...
                    <button
                        ...
                        aria-busy={authLoading}
                        title={!authCode.trim() ? "Please enter a Trakt auth code" : undefined}
                        className={`inline-flex items-center gap-2 px-4 py-2 rounded-lg font-medium transition-colors ${authLoading || !authCode.trim()
                            ? 'bg-transparent border border-[#333] cursor-not-allowed text-gray-600 uppercase tracking-wider'
                            : 'bg-transparent border border-green-600 text-green-500 hover:bg-green-600 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500 uppercase tracking-wider'
                            }`}
                    >
                        {authLoading && <Spinner />}

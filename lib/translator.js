...
export function translateAnilistToTrakt(scrobble, traktShowId, breakpointMap, overrideMap = {}) {
    ...
    // ⚡ BOLT OPTIMIZATION: Replaced expensive O(N log N) array spread + sort inside the loop
    // with a single O(N) linear scan. This function is called in hot loops during full syncs,
    // translating hundreds of scrobbles at a time.
